...
| --- | --- | --- | --- |
| 01 | [Contract setup health behavior and record the architecture](tickets/01-contract-setup-health-behavior-and-record-architecture.md) | None | ready-for-agent |
