...
func TestMarkdownBriefRendersTheSameCanonicalEvidenceWithoutUpstreamBytes(t *testing.T) {
	...
	brief := ReviewBrief{SchemaVersion: 1, Actor: "maintainer", RunID: "1", RunAttempt: "1", RunURL: "https://github.com/owner/repo/actions/runs/1", Request: request, Candidate: packsync.Candidate{Commit: candidateA}, PlanID: "plan", BaseSHA: baseA, HeadSHA: headA, Branch: "sync/source", SelectedResources: []packsync.ResourceEvidence{{SHA256: strings.Repeat("4", 64)}}, PreviousSnapshotSHA256: strings.Repeat("3", 64), ProposedSnapshotSHA256: strings.Repeat("5", 64), ApplyStatus: "applied", Validation: ValidationGates{Provenance: true, Classification: true, Reacquisition: true, Apply: true, Diff: true, Ownership: true, MattySuite: true}, DecisionReady: true, ManualMergeRequired: true, InvalidationConditions: []string{"base_changed", "candidate_changed", "provenance_changed", "head_changed", "pr_state_changed"}}
